...
scoreboard players set $aj.animal_alpha.animation.move aj.id 0
scoreboard players set $aj.animal_alpha.animation.skill aj.id 1
scoreboard players set $aj.animal_alpha.animation.attack aj.id 2
scoreboard players set $aj.animal_alpha.animation.death aj.id 3
scoreboard players set $aj.animal_alpha.animation.ready aj.id 4
scoreboard players set $aj.animal_alpha.variant.default aj.id 0
scoreboard players add .aj.last_id aj.id 0
scoreboard players set $aj.loop_mode.loop aj.i 0
scoreboard players set $aj.loop_mode.once aj.i 1
scoreboard players set $aj.loop_mode.hold aj.i 2
scoreboard players set aj.animal_alpha.export_version aj.i 178335110
