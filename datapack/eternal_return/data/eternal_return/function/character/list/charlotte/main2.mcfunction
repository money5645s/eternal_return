## 우클릭 했을 때
execute if entity @s[scores={right=1..}] run tag @s add charlotteskill
execute if entity @s[scores={right=1..}] run tag @s add charlottecool
...
## 스킬
function eternal_return:sys/character/charlotte/skill
...
## 샬럿 태그 보유 시 팀 가입
team join charlotte @s[team=!charlotte]