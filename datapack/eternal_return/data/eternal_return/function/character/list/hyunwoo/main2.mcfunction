## 우클릭 했을 때
execute if entity @s[scores={right=1..}] run tag @s add hyunwooskill
execute if entity @s[scores={right=1..}] run tag @s add hyunwoocool
...
## 스킬
function eternal_return:sys/character/hyunwoo/skill
...
## 현우 태그 보유 시 팀 가입
team join hyunwoo @s[team=!hyunwoo]