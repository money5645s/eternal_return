## 우클릭 했을 때
execute if entity @s[scores={right=1..}] run tag @s add isolskill
execute if entity @s[scores={right=1..}] run tag @s add isolcool
...
## 스킬
function eternal_return:sys/character/isol/skill
