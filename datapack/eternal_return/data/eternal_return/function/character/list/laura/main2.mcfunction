## 우클릭 했을 때
execute if entity @s[scores={right=1..}] run tag @s add lauraskill
execute if entity @s[scores={right=1..}] run tag @s add lauracool
...
## 스킬
function eternal_return:sys/character/laura/skill
