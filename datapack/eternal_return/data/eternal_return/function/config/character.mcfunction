...
## 캐릭터 리스트
    data modify storage config character_list set value [\
        ...
        {no:21,name:"lyanh",\
            aname:"해방",alore1:"이안이 귀신에게 잠식되며 빙의 즉시 주변에 피해를 입히며 시전 위치에 이안이 남게 됩니다.",alore2:"스킬 종료 시 귀신이 살아 있을 경우 해당 위치에서 인간 상태가 됩니다. (스킬 종료 시점 : 이안을 중심으로 지정 범위를 벗어날 경우, 스킬을 재사용 했을 경우)",alore3:"귀신이 사망한 경우 스킬 사용시에 분리되었던 이안 쪽에서 인간 상태가 됩니다.",alore4:"피해량 : 3/5/7/9/11 , 지속시간 : 15/17/19/21/25",acool:"60/55/50/45/40",alevel:0,\
            pname:"사로잡힌 육신",plore1:"귀신에게 몸을 빼앗기지 않기 위해 저항하는 이안은 각 상태에 따라 이동,공격속도가 달라집니다.",plore2:"인간 상태 : 이동속도 -5% ,귀신 상태 : 이동속도 +5%/공격속도 +10%",plore3:"귀신 상태일때 4번째 공격(4의 배수)마다 일정량의 체력을 회복합니다.",plore4:"회복량 : 1/1/2/2/3",pcool:"없음",plevel:0},\
        {no:22,name:"magnus",\
            aname:"강타",alore1:"대상을 후려쳐 피해를 입히고, 왼쪽으로 날려 버립니다",alore2:"대상이 벽에 부딪히면 일정시간 동안 매우 느려지고 실명에 걸립니다.",alore3:"지속시간 : 1/1/2/2/3",alore4:"피해량 : 4/6/8/10/12",acool:"40/35/30/25/20",alevel:0,\
            pname:"근성",plore1:"매그너스가 적을 피격할때 혹은 자신이 피해를 받을때 근성 중첩을 쌓습니다. (근성 중첩 유지시간 2초/최대 5중첩) ",plore2:"근성 중첩 단계별 효과 : 공격속도 +0.2/0.4/0.6/0.8/1  //5중첩시 저항1 효과 추가",plore3:"매그너스가 다루는 망치는 무겁지만 매그너스는 가볍습니다.",plore4:"매그너스 기본 이동속도 +2% ",pcool:"없음",plevel:0},\
        {no:23,name:"markus",\
        ...
        {no:28,name:"silvia",\
            aname:"기동전",alore1:"스킬 사용시 실비아는 바이크을 소환해 탑승합니다. 실비아는 20초(고정)동안 바이크를 타거나 내릴 수 있습니다.",alore3:"바이크 위에서 스킬을 재사용시 실비아가 바라보는 방향으로 점프하여 범위 안의 적들에게 피해를 입히고 공중에 띄웁니다.",alore4:"피해량 : 5/6/7/8/10 , 재사용 쿨타임 : 16/14/12/10/8",acool:"60/55/50/45/40",alevel:0,\
            pname:"그란투리스모",plore1:"패시브 레벨에 따라 바이크의 방어력이 높아집니다. '어? 바이크의 상태가?'",plore2:"레벨당 장착되는 말 갑옷 : 없음/가죽/철/금/다이아",plore3:"실비아가 새로운 지역 8개를 방문하면 200 크레딧을 획득합니다.",plore4:"또한 바이크의 크기가 소폭 감소됩니다. '닦고, 조이고, 기름치자!'",pcool:"없음",plevel:0},\
        {no:29,name:"sissela",\
