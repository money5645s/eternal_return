...
## 캐릭터 리스트
    data modify storage config character_list set value [\
        ...
        {no:25,name:"nathapon",\
            aname:"인스턴트 포토",alore1:"나타폰이 바라보는 방향으로 프레임을 발사하여 적중한 적에게 피해를 입힙니다.",alore2:"프레임을 적에게 적중할 시에 그 위치에 표식을 남기고 1.5초 후부터 3.5초동안",alore3:"스킬 재사용을 통해 프레임을 맞춘 적에게 방어력을 관통하는 피해를 입히고 표식이 남긴 위치로 되돌려 보낸다.(적이 표식으로부터 너무 멀어지면 재사용 불가)",alore4:"방관비해량 : 4/5/6/7/8",acool:"40/37/34/31/25",alevel:0,\
            pname:"슬로우 셔터",plore1:"나타폰은 매 순간을 카메라에 담기위해 주기적으로 셔터를 닦습니다.",plore2:"셔터를 열심히 닦은 나머지 나타폰이 셔터를 터트려 적에게 공격을 하면 ,적은 4초간 시각(어둠효과)이 축소가됩니다.",plore3:"또한 나타폰은 밤이되어도 카메라를 통해 어두운 부분도 잘 볼 수 있습니다. (야간 투시)",plore4:"",pcool:"30/28/26/24/20",plevel:0},\
        {no:26,name:"piolo",\
