...
## 캐릭터 리스트
    data modify storage config character_list set value [\
        ...
        {no:10,name:"estelle",\
            aname:"",alore1:"",alore2:"",alore3:"",alore4:"",acool:"",alevel:0,\
        ...
        {no:12,name:"hyunwoo",\
            aname:"선빵필승",alore1:"바라보는 방향으로 돌진하며 적과 부딪히면 밀어내며 데미지를 입힌다.",alore2:"밀어낸 적이 벽에 부딪히면 추가 피해를 입고 일정시간동안 슬로우를 겁니다.",alore3:"피해량 : 7/8/9/10/12 , 추가 피해량 : 3/4/5/6/8",alore4:"슬로우 효과 수치 : 99% , 지속시간 2초(고정)",acool:"30/26/22/18/14",alevel:0,\
