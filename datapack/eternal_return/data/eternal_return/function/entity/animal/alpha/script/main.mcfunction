...
function eternal_return:entity/animal/alpha/script/script/0 with storage minecraft:temp temp
...
execute if data entity @e[type=minecraft:zombie      ,tag=this,tag=ER.animal.root  ,limit=1] NoAI run function eternal_return:entity/animal/alpha/script/script/1 
execute unless data entity @e[type=minecraft:zombie      ,tag=this,tag=ER.animal.root  ,limit=1] NoAI run function eternal_return:entity/animal/alpha/script/script/2 
