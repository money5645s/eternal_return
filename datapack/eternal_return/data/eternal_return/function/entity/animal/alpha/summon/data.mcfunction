...
#================================================[야생동물 설정]================================================
#> 체력값 
scoreboard players operation @e[tag= this, tag= ER.animal.root  ] ER.health = #ER.animal.alpha.health ER.sys
scoreboard players operation @e[tag= this, tag= ER.animal.hitbox] ER.health = #ER.animal.alpha.health ER.sys
#> 스킬 쿨타임
scoreboard players operation @e[tag =this, tag= ER.animal.root  ] ER.cooltime = #ER.animal.alpha.cooltime ER.sys
#> 공통 태그 부여
tag @e[tag=this] add ER.animal.alpha
