data modify storage minecraft:temp temp set value {animal : "boar", OPTdistance : 20, damage : 5, attackTick : 12, attackDistance : 5}
...
execute if score #this.HP ER.sys matches 1.. if score #this.AI ER.sys matches 0 run function eternal_return:entity/animal/boar/script/script/3 
execute if score #this.HP ER.sys matches 1.. if score #this.AI ER.sys matches 1 run function eternal_return:entity/animal/boar/script/script/4 
execute if score #this.HP ER.sys matches ..0 run function eternal_return:entity/animal/boar/script/script/5 
