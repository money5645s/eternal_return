...
execute on passengers as @e[tag=ER.animal.model] run function eternal_return:entity/animal_spawn/animal_spawn/animal_spawn/animal_spawn/animal_spawn/animal_spawn/1 
