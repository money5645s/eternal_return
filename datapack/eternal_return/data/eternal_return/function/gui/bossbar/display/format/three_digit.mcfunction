...
# 숫자가 9 이하인 경우
$execute if score #input.number NUM matches ..9 run data modify storage temp format_num set value "00$(input_num)"

# 숫자가 10..99인 경우
$execute if score #input.number NUM matches 10..99 run data modify storage temp format_num set value "0$(input_num)"
