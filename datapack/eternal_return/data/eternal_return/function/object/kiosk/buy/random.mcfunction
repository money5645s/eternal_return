...
execute if score @s credit matches 300.. if score #random_buy NUM matches 4 run give @s armadillo_scute[lore=[{"color":"#993bda","italic":false,"text":"영웅"},{"color":"gray","italic":false,"text":"재료"}],max_stack_size=3,tooltip_style="force_core"] 1
