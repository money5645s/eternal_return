## 모델링 소환
    ...
    # 아미스텐드 소환
        summon armor_stand ~ ~ ~ {NoGravity:1b,Silent:1b,Invisible:1b,Tags:["kiosk","model"],DisabledSlots:4144959,equipment:{head:{id:"minecraft:creeper_banner_pattern",count:1,components:{"minecraft:custom_model_data":{strings:["kiosk"]}}}}}
    # 고개 돌리기
