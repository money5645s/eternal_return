...
execute if entity @s[tag=kill_animal_bear] run give @s beef[lore=[{"color":"#B7B7B7","italic":false,"text":"일반"},{"color":"gray","italic":false,"text":"음식"}],food={nutrition:1,saturation:1,can_always_eat:true},consumable={consume_seconds:0.5,on_consume_effects:[{type:"minecraft:apply_effects",effects:[{id:"minecraft:regeneration",amplifier:0,duration:140}]}]},max_stack_size=6] 2
...
execute if entity @s[tag=kill_animal_wolf] run give @s beef[lore=[{"color":"#B7B7B7","italic":false,"text":"일반"},{"color":"gray","italic":false,"text":"음식"}],food={nutrition:1,saturation:1,can_always_eat:true},consumable={consume_seconds:0.5,on_consume_effects:[{type:"minecraft:apply_effects",effects:[{id:"minecraft:regeneration",amplifier:0,duration:140}]}]},max_stack_size=6] 1
...
execute if entity @s[tag=kill_animal_boar] run give @s beef[lore=[{"color":"#B7B7B7","italic":false,"text":"일반"},{"color":"gray","italic":false,"text":"음식"}],food={nutrition:1,saturation:1,can_always_eat:true},consumable={consume_seconds:0.5,on_consume_effects:[{type:"minecraft:apply_effects",effects:[{id:"minecraft:regeneration",amplifier:0,duration:140}]}]},max_stack_size=6] 1
