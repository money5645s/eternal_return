## 캐릭터 슬롯 클릭
    ...
    # 랜덤 클릭시(베타테스트 전용)
    execute if score @s select matches 100 store result score #random_sel TEMP run random value 1..7
    ...
    execute if score @s select matches 100 if score #random_sel TEMP matches 5 run scoreboard players set @s select 131
    execute if score @s select matches 100 if score #random_sel TEMP matches 6 run scoreboard players set @s select 132
    execute if score @s select matches 100 if score #random_sel TEMP matches 7 run scoreboard players set @s select 133
