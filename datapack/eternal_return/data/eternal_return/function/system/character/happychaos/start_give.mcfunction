...
item replace entity @s container.2 with minecraft:disc_fragment_5[item_name='{"color":"light_purple","text":"[ 스케이프 고트 ]"}',food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:1000000}] 1
item replace entity @s container.4 with nether_star[item_name='{"color":"dark_purple","text":"[ 데우스 엑스 마키나 ]"}',food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:1000000}] 1
