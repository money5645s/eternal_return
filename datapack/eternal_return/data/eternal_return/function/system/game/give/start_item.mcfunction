...
execute as @a[tag=player] run item replace entity @s container.7 with red_bed[food={nutrition:0,saturation:0,can_always_eat:true,eat_seconds:1000000}] 1
...
execute as @a[tag=player,tag=echion] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=elena] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=estell] run item replace entity @s container.4 with shield
execute as @a[tag=player,tag=hyunwoo] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=isol] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=laura] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=lidailin] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=vianca] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=charlotte] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=heart] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=yohan] run item replace entity @s container.4 with carrot_on_a_stick
execute as @a[tag=player,tag=yuki] run item replace entity @s container.4 with carrot_on_a_stick

execute as @a[tag=player,tag=happy] run function eternal_return:system/character/happychaos/start_give