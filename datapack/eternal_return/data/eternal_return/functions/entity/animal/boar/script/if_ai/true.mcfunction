...
execute as @e[\
    ...
    tag= ER.animal.model,\
    tag= this] run function animated_java:animal_boar/animations/ready/stop
...
execute at @e[tag= this,tag= ER.animal.attackDetection] \
    ...
    tag= ER.animal.model,\
    tag= this,\
    ] if entity @p[distance=0..1] run function eternal_return:entity/animal/boar/script/attack 
...
#>    tag= ER.animal.model,\
#>    tag= this,\
#>    ] if entity @p[distance=0..1] run function eternal_return:entity/animal/boar/script/skill
