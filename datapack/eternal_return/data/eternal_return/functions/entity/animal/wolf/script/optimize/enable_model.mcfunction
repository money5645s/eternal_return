...
tag @e[tag= this, tag= aj.animal_wolf.root] add ER.animal.wolf
tag @e[tag= this, tag= aj.animal_wolf.root] add ER.animal
scoreboard players operation @e[tag= this, tag= aj.animal_wolf.root] df_id = @s df_id
