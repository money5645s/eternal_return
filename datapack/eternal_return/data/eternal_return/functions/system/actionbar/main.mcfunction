# 로딩바 표기
execute if entity @s[tag=show_loading] run function eternal_return:temp/input/id
...
execute if entity @s[tag=show_loading] run function eternal_return:temp/free/id

# 개인 스토리지 텍스트 받아오기
execute if entity @s[tag=get_text] run function eternal_return:temp/input/id
...
execute if entity @s[tag=get_text] run function eternal_return:temp/free/id
