...
execute as @a[tag=aya,scores={dmgtaken=0..}] at @s run playsound minecraft:entity.wither.death player @a ~ ~ ~ 1 2

## 아야 스킬 효과
execute as @a[tag=ayaskill] run effect give @s absorption infinite 0 true
...
## 아야 스킬 쿨타임
execute as @a[tag=ayacool] run scoreboard players add @s ayacool 1
execute as @a[scores={ayacool=240}] run tellraw @s ["",{"text":"3초 후 패시브 스킬이 활성화 됩니다.","color":"yellow"}]
execute as @a[scores={ayacool=260}] run tellraw @s ["",{"text":"2초 후 패시브 스킬이 활성화 됩니다.","color":"yellow"}]
execute as @a[scores={ayacool=280}] run tellraw @s ["",{"text":"1초 후 패시브 스킬이 활성화 됩니다.","color":"yellow"}]
execute as @a[scores={ayacool=300}] run tellraw @s ["",{"text":"패시브 활성화!","color":"aqua"}]
execute as @a[scores={ayacool=300..}] run tag @s remove ayacool
execute as @a[scores={ayacool=300..}] run scoreboard players reset @s ayacool
...
execute as @a[scores={ayacool=1..}] unless entity @s[tag=aya] run scoreboard players reset @s ayacool
