...
execute as @a[tag=hyunwooskill,scores={hyunwooskill=1}] at @s if block ^ ^ ^1 air run tp @s ^ ^ ^0.5
execute as @a[tag=hyunwooskill,scores={hyunwooskill=2}] at @s if block ^ ^ ^1 air run tp @s ^ ^ ^0.5
execute as @a[tag=hyunwooskill,scores={hyunwooskill=3}] at @s if block ^ ^ ^1 air run tp @s ^ ^ ^0.5
execute as @a[tag=hyunwooskill,scores={hyunwooskill=4}] at @s if block ^ ^ ^1 air run tp @s ^ ^ ^0.5
execute as @a[tag=hyunwooskill,scores={hyunwooskill=5}] at @s if block ^ ^ ^1 air run tp @s ^ ^ ^0.5
execute as @a[tag=hyunwooskill,scores={hyunwooskill=6}] at @s if block ^ ^ ^1 air run tp @s ^ ^ ^0.5
execute as @a[tag=hyunwooskill,scores={hyunwooskill=7}] at @s if block ^ ^ ^1 air run tp @s ^ ^ ^0.5
execute as @a[tag=hyunwooskill,scores={hyunwooskill=8}] at @s if block ^ ^ ^1 air run tp @s ^ ^ ^0.5
execute as @a[tag=hyunwooskill,scores={hyunwooskill=9}] at @s if block ^ ^ ^1 air run tp @s ^ ^ ^0.5
...
## 현우 스킬 효과 제거
execute as @a[tag=hyunwooskill] at @s unless block ^ ^ ^1 air run kill @e[tag=hyunwoom,limit=1,sort=nearest]
execute as @a[tag=hyunwooskill] at @s unless block ^ ^ ^1 air run scoreboard players reset @s hyunwooskill
execute as @a[tag=hyunwooskill] at @s unless block ^ ^ ^1 air run tag @s remove hyunwooskill
