...
public class Alpha extends ERAnimal {
    public Alpha(@NotNull ERAJEntity erAjEntity, @NotNull Location location) {
        super(erAjEntity, PluginInstance.getEREngine().createOrientedBox(location,1.0/2,3.0/2,1.0/2));
