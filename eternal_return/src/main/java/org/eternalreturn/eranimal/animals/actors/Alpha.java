...
public class Alpha extends ERAnimal {
    public Alpha(@NotNull DPEngine engine, @NotNull ERAJEntity erAjEntity, @NotNull Location location) {
        super(engine, erAjEntity, engine.createOrientedBox(location,1.0/2,3.0/2,1.0/2));
