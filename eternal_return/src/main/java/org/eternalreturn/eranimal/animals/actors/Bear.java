...
public class Bear extends ERAnimal {
    public Bear(@NotNull DPEngine engine, @NotNull ERAJEntity erAjEntity, @NotNull Location location) {
        super(engine, erAjEntity, engine.createOrientedBox(location,3.0/2,3.0/2,2.0/2));
