...
execute if entity @s[tag= aj.animal_bear.animation.attack.playing] run return run function eternal_return:entity/animal/bear/behav/b1/b1/b1/code
execute if entity @s[tag=!aj.animal_bear.animation.attack.playing] if entity @p[tag=targeted, distance=..4] run return run function eternal_return:entity/animal/bear/behav/b1/b1/b2/code
