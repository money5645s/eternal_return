...
execute as @e[type=minecraft:ghast, tag=ER.animal.hitbox] if score @s df_id = #this.id ER.sys run function eternal_return:entity/animal/boar/script/b1/code
...
execute if score #this.HP ER.sys matches 1.. run function eternal_return:entity/animal/boar/script/b2/code
execute if score #this.HP ER.sys matches ..0 run function eternal_return:entity/animal/boar/script/b3/code
