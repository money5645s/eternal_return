...
execute if score #cmp1 sys > #cmp2 sys run function test:bubble_sort_opt/b1/b1/b1/code with storage minecraft:temp temp
...
execute if score #j2 sys matches ..29 run function test:bubble_sort_opt/b1/b1/code with storage minecraft:temp temp
