...
if thisHP == ..0 :
    ...
    execute on passengers if entity @s[tag=this]:
        if entity @s[type=minecraft:item_display, tag= aj.animal_bear.animation.death.playing,\
        ...
        if entity @s[type=minecraft:item_display, tag= ER.animal.model, tag= !aj.animal_bear.animation.death.playing]:
            function animated_java:animal_bear/animations/attack/stop
            function animated_java:animal_bear/animations/move/stop
            function animated_java:animal_bear/animations/skill/stop
