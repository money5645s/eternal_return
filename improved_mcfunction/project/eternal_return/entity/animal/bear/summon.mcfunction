...
entity ModelEntity is @e[type=minecraft:item_display, tag= this, tag= aj.animal_bear.root]
entity HPbarEntity is @e[type=minecraft:text_display, tag= this, tag= ER.animal.HPbar]

##params
op #health ER.sys = #ER.animal.bear.health ER.sys
op #cooltime ER.sys = #ER.animal.bear.cooltime ER.sys
...
execute as @e[type=minecraft:husk, tag= this, tag= ER.animal.root]:
    ...
    execute as @e[type=minecraft:item_display, tag= aj.animal_bear.root] if score @s aj.id = aj.last_id aj.id :
